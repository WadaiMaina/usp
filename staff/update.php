...
<body>
	<div data-role="page" id="update" data-url="/usp/staff/update" data-title="Unimaid | Students' Records">
		<div class="links">
		</div>
		...
		<?php $id = filter_input(INPUT_GET, 'linkId', FILTER_DEFAULT);
		$stmt = $dbh->prepare("SELECT id, idn, ca, exam FROM user_data LEFT JOIN results ON userId = id WHERE courseId = ? AND sesion = '2013/2014'");
			...
			<tbody>
				...
				if(!empty($students)) {
					...
					<tr>
						...
						<td><input type="text" name="ca[]" value="<?php print($student[2]); ?>"></td>
						<td><input type="text" name="exam[]" value="<?php print($student[3]); ?>"></td>
					</tr>
					<?php
					}
				} ?>
