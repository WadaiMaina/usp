...
<body>
	<div data-role="page" id="first-semester" data-title="StudentsPortal | <?php echo $user->fname; ?> | Results">
		...
		<section class="navigation">
			<nav id="main-nv">
				<ul data-role="listview" data-inset="true">
					...
					<li><a href="../exit" data-ajax="false">Log out</a></li>
				</ul>
			</nav>
		</section><!-- /navigation -->
		...
		<section data-role="content" class="main">
			<header data-role="header" id="session">
				<h1>First Semster, <?php echo $sesion; ?> Session</h1>
			</header>
			
			<?php if(checkResult($dbh, $_SESSION['usr_id'], $sesion) == true): ?>
		<table data-role="table" id="temp-table_one" data-mode="reflow" class="ui-responsive table-stroke">
			<thead>
				<tr>
			...
			<tbody>
			<?php 
			getResult($dbh, $_SESSION['usr_id'], 1, $sesion);
